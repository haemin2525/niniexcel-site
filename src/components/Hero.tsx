...
export default function Hero() {
  ...
  return (
    <header className="py-32 sm:py-40 lg:py-48">
      ...
      <h1 className="mt-8 sm:mt-10 font-display font-semibold tracking-[-0.02em] leading-[1.05] text-head">
        <span
        ...
        <span
          className="block anim-fade-up text-accent mt-1 sm:mt-2"
      ...
      <p
        className="mt-8 sm:mt-10 text-body anim-fade-up"
